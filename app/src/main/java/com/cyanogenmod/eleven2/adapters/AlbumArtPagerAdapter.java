...
import com.cyanogenmod.eleven2.widgets.SquareImageView;
...
public class AlbumArtPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public static class AlbumArtFragment extends Fragment implements ICacheListener {
        private static final String ID = "com.cyanogenmod.eleven2.adapters.AlbumArtPagerAdapter.AlbumArtFragment.ID";
